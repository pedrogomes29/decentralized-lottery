...
5. Register contract address as a  new upkeep

Go to [keepers.chain.link](https://keepers.chain.link) and press `Register new upkeep`. Choose a starting balance of at least 5 but be prepared to fund some more LINK if it says 5 is insufficient. Choose the same gas limit as in 
the `callbackGasLimit` in the `helper-hardhat-config.js` file for the given network.
[You can follow the instructions](https://docs.chain.link/docs/chainlink-keepers/register-upkeep/) if you get lost.
